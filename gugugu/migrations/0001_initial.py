# Generated by Django 2.1.5 on 2019-02-06 08:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=50, null=True, validators=[django.core.validators.RegexValidator(re.compile('^[-\\w]+\\Z'), "Enter a valid 'slug' consisting of Unicode letters, numbers, underscores, or hyphens.", 'invalid')])),
                ('date_updated', models.DateTimeField(default=datetime.datetime)),
            ],
        ),
        migrations.CreateModel(
            name='Message',
